...
const PaymentIcon = memo(function PaymentIcon() {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    switch (role) {
        ...
        case 'accounts':
            return [
                ...
                { href: ROUTES.ACCOUNTS_JOBS, label: 'Jobs & Payments', icon: JobsIcon },
                { href: ROUTES.ACCOUNTS_PAYMENTS, label: 'Payment History', icon: PaymentIcon },
                { href: ROUTES.ACCOUNTS_REIMBURSEMENTS, label: 'Reimbursements', icon: ReimbursementIcon },
            ];
        case 'salesperson':
            return [
