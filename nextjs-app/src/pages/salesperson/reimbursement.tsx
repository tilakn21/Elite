/**
 * Salesperson Reimbursement Request Screen
...
export default function ReimbursementPage() {
    ...
    useEffect(() => {
        async function fetchName() {
            ...
            const profile = await salespersonService.getProfile(salespersonId);
            if (profile) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!validateForm() || !salespersonId) return;
    ...
    return (
        <>
            <Head>
                <title>Reimbursement Request | Elite Signboard</title>
            </Head>
