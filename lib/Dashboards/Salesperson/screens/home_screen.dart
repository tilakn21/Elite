...
class _SalespersonHomeScreenState extends State<SalespersonHomeScreen> {
  ...
  Widget build(BuildContext context) {
    final List<_SiteVisitItem> visits = [
      ...
      _SiteVisitItem('S006', 'Jacob Jones', 'assets/images/avatar5.png', '21/12/2022', false),
      _SiteVisitItem('S007', 'Jacob Jones', 'assets/images/avatar5.png', '21/12/2022', false),
      _SiteVisitItem('S008', 'Brooklyn Simmons', 'assets/images/avatar1.png', '21/12/2022', true),
      _SiteVisitItem('S009', 'Kristin Watson', 'assets/images/avatar2.png', '21/12/2022', false),
    ];
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: item.submitted ? Color(0xFFD2F6E7) : Color(0xFFFFE3E3),
              borderRadius: BorderRadius.circular(8),
            ),
            child: Text(
              item.submitted ? 'Submitted' : 'Pending',
              style: TextStyle(
                color: item.submitted ? Color(0xFF3BB77E) : Color(0xFFD32F2F),
